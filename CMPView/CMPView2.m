function varargout = CMPView2(varargin)
% CMPVIEW2 M-file for CMPView2.fig
%      CMPVIEW2, by itself, creates a new CMPVIEW2 or raises the existing
%      singleton*.
%
%      H = CMPVIEW2 returns the handle to a new CMPVIEW2 or the handle to
%      the existing singleton*.
%
%      CMPVIEW2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CMPVIEW2.M with the given input arguments.
%
%      CMPVIEW2('Property','Value',...) creates a new CMPVIEW2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CMPView2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CMPView2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help CMPView2
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @CMPView2_OpeningFcn, ...
                   'gui_OutputFcn',  @CMPView2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CMPView2 is made visible.
function CMPView2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CMPView2 (see VARARGIN)
...
%We expect CMPView2 to be run from the CMPView2 directory
[workingDir,mfile, ext] = fileparts(which(mfilename));
libDir = fullfile(workingDir, 'libs'); 
libDirs = genpath(libDir);
path(libDirs, path); 

% Choose default command line output for CMPView2
...
% UIWAIT makes CMPView2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = CMPView2_OutputFcn(hObject, eventdata, handles) 
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    defaultDataPath = getpref('CMPView2', 'DataPath', []);
    ...
    setpref('CMPView2', 'DataPath', directory_name);
...
function menuFile_SaveCollection_Callback(hObject, eventdata, handles)
    ...
    % they did not
     ...
     setpref('CMPView2', 'DataPath', defaultDataPath);
